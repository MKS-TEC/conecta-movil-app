...
import 'package:conecta/presentation/pet/create_pet/pet_information.dart';
...
class _SelectedPetTypeState extends State<SelectedPetType> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => getIt<CreatePetBloc>()..add(GetSpecies()),
    ...
    return Padding(
      ...
      child: Column(
        children: <Widget>[
          ...
          SizedBox(height: 35),
          Text(
            'Selecciona qué tipo de mascota tienes',
            style: TextStyle(
              color: Color(0xFF6F7177),
              fontSize: 16,
