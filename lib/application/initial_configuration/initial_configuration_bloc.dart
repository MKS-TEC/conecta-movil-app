...
@injectable
class InitialConfigurationBloc extends Bloc<InitialConfigurationEvent, InitialConfigurationState> {
  ...
  InitialConfigurationBloc(this._speciesRepository, this._breedRepository, this._calendarRepository, this._programRepository, this._programCategoryRepository, this._peetRepository) : super(Initial());

  @override
  Stream<InitialConfigurationState> mapEventToState(
    InitialConfigurationEvent event,
  ) async* {
  ...
  Stream<InitialConfigurationState> _getSpecies(GetSpecies event) async* {
  ...
  Stream<InitialConfigurationState> _getBreedsBySpecies(GetBreedsBySpecies event) async* {
  ...
  Stream<InitialConfigurationState> _setPet(SetPet event) async* {
  ...
  Stream<InitialConfigurationState> _getPrograms(GetPrograms event) async* {
  ...
  Stream<InitialConfigurationState> _createPrograms(CreatePrograms event) async* {
  ...
  Stream<InitialConfigurationState> _createCalendar(CreateCalendar event) async* {
